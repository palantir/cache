...
final class CaffeineLoadingCacheRefactoringTest {
    ...
    private RefactoringValidator fix() {
        return RefactoringValidator.of(CaffeineLoadingCacheRefactoring.class, getClass());
    }
    ...
    void handles_legacy_cache_name() {
        fix().addInputLines(
                ...
                .addOutputLines(
                        ...
                        "  private AsyncLoadingCache<String, String> cache;",
                        "",
                        "  // legacyName() is used to preserve metric flows for existing caches; consider changing the"
                                + " cache",
    ...
    void nested_type_params_on_cache_type_params_are_preserved() {
        // verify that all nested type arguments are preserved
        // we also verify that fully-qualified type references in those parameters (in this case, java.util.List)
        // are preserved when necessary (adding an import for java.util.List would conflict with the private
        // interface type "List")
        fix().addInputLines(
                        "Test.java",
                        "import com.github.benmanes.caffeine.cache.Caffeine;",
